...
def test_collections_counter_a():
    ...
    rhagu_shoe_orders(['2', '3', '4', '5', '6', '8', '7', '6', '5', '18'],[['6', '55'], ['6', '45'], ['6', '55'], ['4', '40'], ['18', '60'], ['10', '50']])                                  # Call function.
...
def test_collections_counter_b():
    capturedOutput = io.StringIO()                  # Create StringIO object
    sys.stdout = capturedOutput                     #  and redirect stdout.
    rhagu_shoe_orders(['3', '9', '6', '9', '3', '8', '7', '12', '4', '18'],[['5', '25'], ['6', '36'], ['9', '81'], ['4', '16'], ['18', '60'], ['10', '50']])                                  # Call function.
    sys.stdout = sys.__stdout__                     # Reset redirect.
...
def test_collections_counter_c():
    capturedOutput = io.StringIO()                  # Create StringIO object
    sys.stdout = capturedOutput                     #  and redirect stdout.
    rhagu_shoe_orders(['9', '9', '9', '9', '9'],[['6', '55'], ['9', '45'], ['6', '55'], ['9', '40'], ['18', '60'], ['10', '50']])                                  # Call function.
    sys.stdout = sys.__stdout__                     # Reset redirect.

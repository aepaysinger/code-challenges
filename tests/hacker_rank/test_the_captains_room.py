...
def test_find_the_captain():
    actual = find_the_captain("1 2 3 6 5 4 4 2 5 3 6 1 6 5 3 2 4 1 2 5 1 4 3 6 8 4 3 1 5 6 2".split(" "))
    expected = '8'    
...
def test_find_the_captain_and_crew():
    actual = find_the_captain("1 2 3 6 5 9 4 2 5 3 6 1 6 1 4 3 6 8 4 3 1 5 6 2".split(" "))
